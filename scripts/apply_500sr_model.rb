...
def add_500sr_mega_item!(html)
  ...
  html.gsub!("29 model", "30 model")
  return html if html.include?('href="/model/500sr/" class="mega-model"')
  ...
  item = <<~HTML.delete("\n")
    <a href="/model/500sr/" class="mega-model" role="menuitem"><div><img src="/models/cards/500sr.webp" alt="500SR rəsmi foto" loading="lazy" decoding="async" fetchpriority="low"/><em>Yeni</em></div><span>Sport Racing<!-- --> · <!-- -->500 cc</span><h3>500SR</h3><p>Qiyməti dəqiqləşdirin<!-- --> <b>↗︎</b></p></a>
  HTML
...
def add_500sr_home_card!(home)
  ...
  home.gsub!("47 aktual model", "48 aktual model")
  return home if home.include?('href="/model/500sr/" class="model-visual"')
...
def patch_model_bundle!(javascript, path)
  return javascript if javascript.include?('slug:`500sr`')

  anchor = javascript[%r{\{slug:`500sr-voom`,[^{}]+\}}]
  abort "#{File.basename(path)}: 500SR VOOM data anchor not found" unless anchor
  entry = '{slug:`500sr`,name:`500SR`,type:`Motosiklet`,segment:`Sport Racing`,engineClass:`500 cc`,price:null,image:`/models/500sr.webp`,officialPage:`https://www.cfmoto.com/global/motorcycles/sportracing/500sr.html`,badge:`Yeni`}'
...
def custom_page(template)
  ...
  schema = {
    ...
    "@graph" => [
      ...
      },
      {
        ...
        "vehicleConfiguration" => "Sport Racing",
  ...
  <<~HTML
    ...
    <meta name="description" content="Yeni CFMOTO 500SR: 500 cc sıralı dörd silindr, 58 kW güc, 49 Nm fırlanma anı, 187 kq çəki və müasir yarış texnologiyaları."/>
    ...
    #{header}
    <section class="product-hero" id="icmal"><div class="product-copy"><div class="breadcrumb"><a href="/">Ana səhifə</a><span>/</span><a href="/motosiklet/">Motosikletlər</a><span>/</span><b>500SR</b></div><p class="eyebrow dark"><span></span> Motosiklet · Sport Racing</p><h1 class="product-title">500SR</h1><p class="product-tagline">Sıralı dörd silindrin saf yarış xarakteri.</p><p class="product-summary">500SR aerodinamik SR dizaynını, yüksək dövrlü dörd silindrli mühərriki və dəqiq şassi idarəetməsini bir araya gətirir.</p><div class="product-price"><small>Azərbaycan üçün satış qiyməti</small><strong>Qiyməti soruş</strong></div><div class="hero-actions"><a class="button primary" href="#{WHATSAPP_URL}" target="_blank" rel="noreferrer">Satış təklifi al <span>↗︎</span></a><a class="button ghost" href="#texniki">Texniki göstəricilər</a></div></div><div class="product-image-wrap"><span class="product-badge">Yeni</span><img class="model-color-image" src="/models/500sr.webp" alt="Yeni CFMOTO 500SR rəsmi model fotosu" width="882" height="588"/></div></section>
    ...
    <nav class="model-subnav" aria-label="Model səhifəsi bölmələri"><strong>500SR</strong><div><a href="#icmal">İcmal</a><a href="#xususiyyetler">Xüsusiyyətlər</a><a href="#texniki">Texniki göstəricilər</a><a href="#qalereya">Qalereya</a></div><a class="model-subnav-cta" href="#{WHATSAPP_URL}" target="_blank" rel="noreferrer">Qiyməti soruş ↗︎</a></nav>
    ...
    <section class="product-cta section"><div><p class="eyebrow"><span></span> CFMOTO Azerbaijan</p><h2>500SR haqqında ilk məlumatı al.</h2><p>Qiymət, satış başlanğıcı və Azərbaycan komplektasiyası elan ediləndə satış komandamızdan məlumat alın.</p></div><a class="button primary" href="#{WHATSAPP_URL}" target="_blank" rel="noreferrer">WhatsApp-la əlaqə <span>↗︎</span></a></section>
    #{footer}<div class="model-mobile-cta"><a href="#{WHATSAPP_URL}" target="_blank" rel="noreferrer">Qiyməti soruş ↗︎</a></div><a class="whatsapp model-whatsapp" href="#{WHATSAPP_URL}" target="_blank" rel="noreferrer" aria-label="WhatsApp ilə əlaqə">WA</a></main></body></html>
  HTML
end
