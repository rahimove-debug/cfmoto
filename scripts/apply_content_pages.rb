...
service_body = <<~HTML
  ...
  <section class="prose"><h2>İş saatları və əlaqə</h2><p>Bazar ertəsi istisna olmaqla servis hər gün saat 10:00–19:00 arasında fəaliyyət göstərir. Qəbul vaxtını və lazım olan xidməti əvvəlcədən dəqiqləşdirmək üçün <a href="tel:#{SERVICE_PHONE}" data-contact-area="service"><strong>#{SERVICE_PHONE_DISPLAY}</strong></a> nömrəsinə zəng edin.</p><h2>Şəhərdaxili aparıb-gətirmə</h2><p>Motosikletin servisə aparılması və geri qaytarılması xidməti şəhər daxilində 45 AZN-dir.</p><h2>Servis sorğusuna necə hazırlaşmalı?</h2><p>Zəng etməzdən əvvəl texnikanın tam modelini, istehsal ilini və mümkündürsə cari yürüşünü və ya iş saatını qeyd edin. Səs, xəbərdarlıq işığı, işə düşmə çətinliyi və ya idarəetmədə dəyişiklik müşahidə etmisinizsə, əlamətin nə vaxt başladığını və hansı şəraitdə təkrarlandığını qısa izah edin. Bu məlumat servis komandasının müraciəti daha düzgün anlamasına kömək edir.</p><ul><li>Modelin tam adı və istehsal ili</li><li>Cari yürüş və ya iş saatı</li><li>Müşahidə olunan əlamətin qısa təsviri</li><li>Son texniki qulluq barədə mövcud məlumat</li></ul><h2>Qəbul və növbəti addım</h2><p>Telefon danışığında qəbul vaxtını, texnikanın servisə necə çatdırılacağını və ilkin baxış üçün lazım olan məlumatları dəqiqləşdirin. Planlı qulluq üçün modelə aid servis intervalını, nasazlıq şübhəsi olduqda isə istifadə və servis tarixçəsini hazır saxlayın. Görüləcək iş və ehtiyac duyulan hissələr texniki baxışdan sonra dəqiqləşdirilir.</p><div class="notice">Servis ünvanını, qəbul vaxtını və ehtiyac duyulan işi telefonla əvvəlcədən dəqiqləşdirin.</div></section>
...
warranty_body = <<~HTML
  ...
  <section class="prose"><h2>Zəmanət məlumatını necə dəqiqləşdirmək olar?</h2><ul><li>Modelin tam adını və istehsal ilini qeyd edin.</li><li>Satış və zəmanət sənədlərindəki şərtləri yoxlayın.</li><li>Texniki qulluq intervallarını rəsmi servis ilə dəqiqləşdirin.</li><li>Konkret hal üzrə servis komandası ilə əlaqə saxlayın.</li></ul><h2>Qiymətləndirmə üçün hansı məlumatlar lazımdır?</h2><p>Zəmanətlə bağlı müraciət zamanı modelin tam adı, istehsal ili, cari yürüşü və ya iş saatı, alış tarixi və müşahidə olunan halın təsviri faydalıdır. Satış və zəmanət sənədlərini, həmçinin mövcud servis qeydlərini hazır saxlamaq yoxlamanı asanlaşdırır. Xəbərdarlıq işığı, qeyri-adi səs və ya işləmədə dəyişiklik varsa, bunun nə vaxt və hansı şəraitdə baş verdiyini qeyd edin.</p><h2>Zəmanət və texniki baxış</h2><p>Müraciətin zəmanət əhatəsinə daxil olub-olmadığı yalnız müddətə əsasən müəyyən edilmir. Yekun qiymətləndirmədə texniki baxışın nəticəsi, servis tarixçəsi, istehsalçının qulluq tələbləri və təqdim olunan rəsmi sənədlər nəzərə alınır. İstifadə rejimi və model fərqli olduqda şərtlər də dəyişə bilər; buna görə konkret hal üzrə rəsmi servisə müraciət edin.</p><div class="notice">Bu səhifə ümumi məlumat verir. Əhatə dairəsi, istisnalar və yekun şərtlər təqdim olunan rəsmi sənədlərlə müəyyən olunur.</div></section>
...
parts_body = <<~HTML
  ...
  <section class="prose"><h2>Sorğu zamanı hansı məlumatlar lazımdır?</h2><ul><li>CFMOTO modelinin tam adı</li><li>İstehsal ili</li><li>Axtardığınız hissənin adı və ya mövcuddursa kodu</li><li>Uyğunluğu dəqiqləşdirmək üçün texniki məlumat</li></ul><h2>Dəqiq uyğunluq necə yoxlanılır?</h2><p>Eyni modelin istehsal ili və komplektasiyasına görə bəzi hissələri fərqli ola bilər. Buna görə yalnız hissənin görünüşünə əsaslanmaq əvəzinə modelin tam adını, istehsal ilini və mövcuddursa hissə kodunu təqdim edin. Kod məlum deyilsə, hissənin yerləşdiyi yeri və funksiyasını izah edin. Zəruri olduqda servis komandası uyğunluğu dəqiqləşdirmək üçün əlavə texniki məlumat istəyə bilər.</p><h2>Yağ və aksesuar seçimi</h2><p>Yağ seçərkən modelin mühərriki və planlı qulluq intervalı, aksesuar seçərkən isə konkret model və quraşdırma uyğunluğu əsas götürülür. Sorğuda hansı məhsula ehtiyac duyduğunuzu və istifadə məqsədini aydın qeyd edin. Servisə və ya satış nöqtəsinə getməzdən əvvəl uyğunluğu, cari mövcudluğu və yekun qiyməti telefonla təsdiqləyin.</p><h2>Səhv seçim riskini azaldın</h2><p>Məlumatı nə qədər dəqiq təqdim etsəniz, uyğun olmayan hissə və ya aksesuar seçimi ehtimalı bir o qədər azalır. Şübhə olduqda köhnə hissənin kodunu və texniki sənədlərdəki model məlumatını yoxlayın; son uyğunluq təsdiqini servis və ehtiyat hissələri komandasından alın.</p><div class="notice">Məhsul uyğunluğu, qiymət və mövcudluq telefon sorğusu zamanı dəqiqləşdirilir.</div></section>
