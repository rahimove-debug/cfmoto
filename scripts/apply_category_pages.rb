...
CONFIG = {
  "motosiklet" => {
    ...
    summary: "Model kartlarında mühərrik sinfini və nağd satış qiymətini yoxlayın; texniki göstəricilər, rənglər və ödəniş hesablaması üçün model səhifəsini açın.",
  ...
  "kvadrosikl" => {
    ...
    summary: "Hər kvadrosiklin mühərrik sinfi və nağd satış qiyməti aşağıda göstərilir. Avadanlıq və texniki göstəriciləri model səhifəsində yoxlayın.",
  ...
  "buggy" => {
    ...
    summary: "Oturacaq və yükdaşıma ehtiyacınıza uyğun modeli seçin, sonra onun texniki göstəricilərini və ödəniş imkanlarını nəzərdən keçirin.",
